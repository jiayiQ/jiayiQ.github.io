...
!(function (e, t, n) {
  ...
  function h(e, t, n) {
    ...
    for (var i in e)
      if (e[i] in t)
        return n === !1
          ? e[i]
          : ((r = t[e[i]]), o(r, "function") ? m(r, n || t) : r);
    return !1;
  }
  function v(e, t, r, i) {
    function a() {
    ...
    for (
      var c, d, m, h, v, g = ["modernizr", "tspan", "samp"];
      !M.style && g.length;
    ...
    for (m = e.length, d = 0; m > d; d++)
      if (
        ...
        if (i || o(r, "undefined")) return a(), "pfx" == t ? h : !0;
        try {
          M.style[h] = r;
        } catch (y) {}
  ...
  var N = "Moz O ms Webkit",
    T = C._config.usePrefixes ? N.toLowerCase().split(" ") : [];
  C._domPrefixes = T;
  var j = (function () {
    function e(e, t) {
      var o;
  ...
  C.prefixedCSSValue = P;
  var z = C._config.usePrefixes ? N.split(" ") : [];
  C._cssomPrefixes = z;
  var k = function (t) {
    var r,
      o = b.length,
  ...
  C.mq = A;
  var F = ((C.testStyles = d), { elem: s("modernizr") });
  Modernizr._q.push(function () {
    delete F.elem;
  });
  ...
  var L = (C.prefixed = function (e, t, n) {
    return 0 === e.indexOf("@")
      ? k(e)
      : (-1 != e.indexOf("-") && (e = u(e)), t ? g(e, t, n) : g(e, "pfx"));
  });
  C.prefixedCSS = function (e) {
    var t = L(e);
    return t && l(t);
  };
  (C.testAllProps = y), i(), r(E), delete C.addTest, delete C.addAsyncTest;
